...
class FlutterTerminalSdk {
  ...
  Future<Map<String, dynamic>> _callAndReturnMapResponse(String methodName,
      dynamic data,) async {
    if (!_initialized) {
  ...
  Future<void> initialize({
    ...
    final uiDockPositionString = uiDockPosition != null ? uiDockPosition.name : null; // "sa", "tr", or "usa"
