...
enum PrinterStatus {
  ...
  initPrinterError2('-١', 'Failed to initialize the printer!'),
  normal('0', 'The printer is normally!'),
  normal2('٠', 'The printer is normally!'),
  notPoweredOn('1', 'The printer is not connected or powered on!'),
  notPoweredOn2('١', 'The printer is not connected or powered on!'),
  notLibraryMatch('2', 'The printer and call library do not match'),
  notLibraryMatch2('٢', 'The printer and call library do not match'),
  openPrintHead('3', 'Print head open!'),
  openPrintHead2('٣', 'Print head open!'),
  cutterNotReset('4', 'The cutter is not reset!'),
  cutterNotReset2('٤', 'The cutter is not reset!'),
  overHeated('5', 'Overheated'),
  overHeated2('٥', 'Overheated'),
  blackLabelError('6', 'Black label error!'),
  blackLabelError2('٦', 'Black label error!'),
  notPaperFeed('7', 'No Paper Feed'),
  notPaperFeed2('٧', 'No Paper Feed'),
  outOfPaper('8', 'Paper Running Out!'),
  outOfPaper2('٨', 'Paper Running Out!'),
  otherError('99', 'Other errors!'),
  otherError2('٩٩', 'Other errors!');
